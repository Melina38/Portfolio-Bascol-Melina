<?php include 'includes/header.php'?>
    ...
    <body>
        ...
        <div class="titre-div container">
            <h2 class="titre-projet">Création d'un site de réservation de matériels multimédia</h2>
            <p>2024</p>
        ...
        <section class="projet-section container">
            ...
            <div class="categories-div">
                <div class="categorie-div">
                    ...
                    <h4>
                        En groupe de 2, on devait créer un site de prêt 
                        pour que les autres étudiants en BUT MMI puisse réservé 
                        du matériel multimédia et de créer une interface 
                        administrative avec un système de CRUD.
                    </h4>
                ...
                <div class="categories-div">
                    <div class="categorie-div">
                        ...
                        <h4>
                            ...
                            -VisualStudioCode pour programmer <br>
